...
<body>
    ...
    <script>
      ...
      document.getElementById('output').textContent = 'Hello, World! （已输出到控制台）';
    </script>
</body>
</html>
```
...
<head>
    <meta charset="UTF-8">
    <title>引入外部脚本文件</title>
    <style>
        body { margin: 0; font-family: sans-serif; padding: 1rem; }
    </style>
</head>
<body>
    <p>通过 <code>&lt;script src="main.js"&gt;</code> 引入外部脚本文件。</p>
...
<body>
    <p>defer：HTML 解析完毕后按顺序执行</p>
    <script src="app.js" defer></script>

    <p>async：下载完立即执行，不保证顺序</p>

...
在你确认设计方案后，Agent 会制定一份实施计划——清晰到连一个热情有余、判断力不足、缺乏项目上下文、不爱写测试的初级工程师都能跟着做。它强调真正的红绿 TDD (Red/Green TDD)、YAGNI (You Aren't Gonna Need It) 和 DRY (Don't Repeat Yourself)。
...
1. **brainstorming**（头脑风暴）——在写代码前激活。通过提问打磨粗略想法，探索替代方案，分段展示设计以供验证。保存设计文档。
